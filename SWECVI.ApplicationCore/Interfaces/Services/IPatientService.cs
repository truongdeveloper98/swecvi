...
namespace SWECVI.ApplicationCore.Interfaces.Services
{
    public interface IPatientService
    {
        ...
        Task<bool> Create(DicomResultMirthViewModel model, int hospitalId, List<ManufacturerDicomParameters> manufacturerDicomParameters, List<DicomTags> dicomTags, List<ParameterVaueViewModel> parameterResultViewModels);
